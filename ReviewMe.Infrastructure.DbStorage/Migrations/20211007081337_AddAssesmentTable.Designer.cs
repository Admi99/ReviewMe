...
namespace ReviewMe.Infrastructure.DbStorage.Migrations
{
    ...
    [Migration("20211007081337_AddAssesmentTable")]
    partial class AddAssesmentTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewMe.Infrastructure.DbStorage.DatabaseObjects.AssesmentDo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReviewMe.Infrastructure.DbStorage.DatabaseObjects.AssesmentDo", b =>
                {
                    b.HasOne("ReviewMe.Infrastructure.DbStorage.DatabaseObjects.EmployeeDo", null)
                        .WithMany("Assesments")
